...
Error: This expression has type {M : S} -> M.t
       but an expression was expected of type {M : S} -> 'aThis expression has type
                                                             M.t
...
1 | let scope_escape4 (f : {M : S} -> M.t) : {N : S} -> 'a = f;;
                                                             ^
Error: This expression has type {M : S} -> M.t
       but an expression was expected of type {N : S} -> 'aThis expression has type
                                                             M.t
       The type constructor M.t would escape its scope
|}]
