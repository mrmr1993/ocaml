...
module Typ :
  sig
    ...
    val arrow: ?loc:loc -> ?attrs:attrs -> string arg_label -> core_type -> core_type
               -> core_type
...
module Exp:
  sig
    ...
    val fun_: ?loc:loc -> ?attrs:attrs -> str arg_label -> expression option
...
module Cty:
  sig
    ...
    val arrow: ?loc:loc -> ?attrs:attrs -> string arg_label -> core_type ->
